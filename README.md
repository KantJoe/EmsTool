...
2. Install VSCode or VS2026
3. clone repo
4. set project 'org.Ui.Poseidon' as startup project
5. change 'target platform' to x64
6. restore solution
7. build & run 'org.Ui.Poseidon'
...
10. Mqtt Transform
11. Privilages
12. Device Topology & Connections (in plan)
13. Testing Automation (in plan)
14. Threldshold & Tendency (in plan)
15. Logs (did, but not integration)
