...
{
    public ref struct ModbusUshortFrame
    {
        ...
        public ushort GetData(int offset)
        {
        ...
        public static ModbusUshortFrame FromBytes(Span<byte> buffer)
        {
            return new ModbusUshortFrame
            {
